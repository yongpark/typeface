...
var require_rosie = __commonJS({
  "node_modules/rosie/src/rosie.js"(exports, module) {
    var Factory = class _Factory {
      constructor(constructor) {
        ...
        this.sequences = {};
        this.callbacks = [];
        _Factory._allFactories.push(this);
      }
      /**
      ...
      _optionValue(opt, options) {
        ...
        return this._buildWithDependencies(
          optMeta,
          (dep) => this._optionValue(dep, options)
        );
      }
      /**
      ...
      _buildWithDependencies(meta, getDep) {
        ...
        const args = deps.map((...args2) => getDep.apply(this, args2));
       ...
       */
      extend(name) {
        const factory = typeof name === "string" ? _Factory.factories[name] : name;
        if (this.construct === void 0) {
